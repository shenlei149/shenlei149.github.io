...
这些代码能工作，所以没想着改成 C++11 的风格，但是又想借助移动语义来提高性能。首先，需要确保 `Widget` 支持移动，可以手写也可以由编译器自己合成，参见 [Item 17](/EffectiveModernCpp/ch03_Moving_to_Modern_C++/17_Understand_special_member_function_generation.md)。
